...
function detectOs(){var t="Windows";return-1!==navigator.appVersion.indexOf("Mac")&&(t="Mac"),t}function detectBrowser(){var t,e=navigator.userAgent,r=e.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(r[1])?(t=/\brv[ :]+(\d+)/g.exec(e)||[],"IE "+(t[1]||"")):"Chrome"===r[1]&&(t=e.match(/\bOPR\/(\d+)/),null!=t)?"Opera "+t[1]:(r=r[2]?[r[1],r[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(t=e.match(/version\/(\d+)/i))&&r.splice(1,1,t[1]),r)}function capitaliseFirstLetter(t){return t.charAt(0).toUpperCase()+t.slice(1)}function uniqueId(){return Math.round((new Date).getTime()+100*Math.random())}function getImgFromInput(t,e){if(inputContainImg(t)){var r=t.prop("files")[0],n=new FileReader;n.onload=function(t){$("<img/>").attr("src",t.target.result).load(function(){var r={width:this.width,height:this.height,base64:t.target.result};e(r)})},n.readAsDataURL(r)}else e(!1)}function inputContainImg(t){var e=t[0].files[0],r=e.type;return"image/gif"===r||"image/jpeg"===r||"image/jpg"===r||"image/png"===r?!0:!1}function svgToBase64(t){var e="data:image/svg+xml;base64,"+btoa(t);return e}function hyphensToCamelCase(t){var e=t.replace(/-([a-z])/g,function(t){return t[1].toUpperCase()});return e}function colorsStrToArray(t){return t.split(/(?:,(?=#)|,(?=r))+/)}function cleanFilename(t){var e=t.lastIndexOf("."),r=t.slice(0,e);return r=r.replace(/_/g," ")}function getDomainFromUrl(t){var e=t,r=t.match(/^https?\:\/\/(?:www\.)?([^\/?#]+)(?:[\/?#]|$)/i);return r&&r[1]&&(e=r&&r[1]),e}function addHttpIfMissing(t){return/^https?:\/\//i.test(t)||(t="http://"+t),t}