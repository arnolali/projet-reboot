...
function detectOs(){var e="Windows";return-1!==navigator.appVersion.indexOf("Mac")&&(e="Mac"),e}function detectBrowser(){var e,t=navigator.userAgent,i=t.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(i[1])?(e=/\brv[ :]+(\d+)/g.exec(t)||[],"IE "+(e[1]||"")):"Chrome"===i[1]&&(e=t.match(/\bOPR\/(\d+)/),null!=e)?"Opera "+e[1]:(i=i[2]?[i[1],i[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=t.match(/version\/(\d+)/i))&&i.splice(1,1,e[1]),i)}function capitaliseFirstLetter(e){return e.charAt(0).toUpperCase()+e.slice(1)}function uniqueId(){return Math.round((new Date).getTime()+100*Math.random())}function getImgFromInput(e,t){if(inputContainImg(e)){var i=e.prop("files")[0],a=new FileReader;a.onload=function(e){$("<img/>").attr("src",e.target.result).load(function(){var i={width:this.width,height:this.height,base64:e.target.result};t(i)})},a.readAsDataURL(i)}else t(!1)}function inputContainImg(e){var t=e[0].files[0],i=t.type;return"image/gif"===i||"image/jpeg"===i||"image/jpg"===i||"image/png"===i?!0:!1}