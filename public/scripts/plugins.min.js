...
function detectOs(){var e="Windows";return-1!==navigator.appVersion.indexOf("Mac")&&(e="Mac"),e}function detectBrowser(){var e,t=navigator.userAgent,a=t.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(a[1])?(e=/\brv[ :]+(\d+)/g.exec(t)||[],"IE "+(e[1]||"")):"Chrome"===a[1]&&(e=t.match(/\bOPR\/(\d+)/),null!=e)?"Opera "+e[1]:(a=a[2]?[a[1],a[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=t.match(/version\/(\d+)/i))&&a.splice(1,1,e[1]),a)}function capitaliseFirstLetter(e){return e.charAt(0).toUpperCase()+e.slice(1)}function uniqueId(){return Math.round((new Date).getTime()+100*Math.random())}function getImgFromInput(e,t){if(inputContainImg(e)){var a=e.prop("files")[0],i=new FileReader;i.onload=function(e){$("<img/>").attr("src",e.target.result).load(function(){var a={width:this.width,height:this.height,base64:e.target.result};t(a)})},i.readAsDataURL(a)}else t(!1)}function inputContainImg(e){var t=e[0].files[0],a=t.type;return"image/gif"===a||"image/jpeg"===a||"image/jpg"===a||"image/png"===a?!0:!1}function svgToBase64(e){var t="data:image/svg+xml;base64,"+btoa(e);return t}