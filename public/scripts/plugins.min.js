...
function detectOs(){var e="Windows";return-1!==navigator.appVersion.indexOf("Mac")&&(e="Mac"),e}function detectBrowser(){var e,t=navigator.userAgent,r=t.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(r[1])?(e=/\brv[ :]+(\d+)/g.exec(t)||[],"IE "+(e[1]||"")):"Chrome"===r[1]&&(e=t.match(/\bOPR\/(\d+)/),null!=e)?"Opera "+e[1]:(r=r[2]?[r[1],r[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=t.match(/version\/(\d+)/i))&&r.splice(1,1,e[1]),r)}function capitaliseFirstLetter(e){return e.charAt(0).toUpperCase()+e.slice(1)}function uniqueId(){return Math.round((new Date).getTime()+100*Math.random())}function getImgFromInput(e,t){if(inputContainImg(e)){var r=e.prop("files")[0],a=new FileReader;a.onload=function(e){$("<img/>").attr("src",e.target.result).load(function(){var r={width:this.width,height:this.height,base64:e.target.result};t(r)})},a.readAsDataURL(r)}else t(!1)}function inputContainImg(e){var t=e[0].files[0],r=t.type;return"image/gif"===r||"image/jpeg"===r||"image/jpg"===r||"image/png"===r?!0:!1}function svgToBase64(e){var t="data:image/svg+xml;base64,"+btoa(e);return t}function hyphensToCamelCase(e){var t=e.replace(/-([a-z])/g,function(e){return e[1].toUpperCase()});return t}function colorsStrToArray(e){return e.split(/(?:,(?=#)|,(?=r))+/)}